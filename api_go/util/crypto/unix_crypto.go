...
// Crypt is a implementation of crypto(3) like as perl or ruby and ...etc.
//
// Behavior of this func is  same as perl-5.18.2's crypto on OSX Yosemite.
func UnixCrypt(pw string, salt string) string {
